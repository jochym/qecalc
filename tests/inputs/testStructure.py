...
Pb      0.50000000  0.50000000  0.50000000  
Pb      0.50000000  0.00000000  0.00000000  
Pb      0.00000000  0.50000000  0.00000000  
Pb      0.00000000  0.00000000  0.50000000  
...
"""
        ...
        struct2 = Structure( [ at1, at2, at3, at4, at5, at6, at7, at8, at9, \
                             at10, at11, at12, at13, at14, at15, at16], \
                             lattice = Lattice(a, a, a, 90, 90, 90))
        self.input.structure.load(structure = struct2, massList = massList, psList = psList)        
...
B    0.333333 0.666667 0.765961 1.0000"""
        #print str(self.input.structure.matter())
        self.assertEqual(str(self.input.structure.matter()), answer)
...
"""
    ...
    def test_writeStr(self):
        answer = """TITLE     Al_1 B_4 Mg_1                                                         
CRYST1    5.789    5.789   12.875  90.00  90.00 120.00                          
...
END                                                                             
"""
        #print self.input.structure.writeStr(format = 'pdb')
...
Atomic positions in crystal coordinates:
Pb     -0.50000000  1.50000000 -0.50000000  
Te      0.00000000  0.00000000  0.00000000  
